...
### Мне пришло какое-то письмо от вас про миграцию на новый SDN, это вообще что и зачем мне это?
(DRAFT) В феврале 2024 года VK Cloud выпустила SDN собственной разработки. В августе это решение стало доступно по-умолчанию для всех клиентов. **Надо мигрировать**.
