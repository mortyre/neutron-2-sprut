...
Причины разработки собственного SDN - Sprut
Neutron не соответствует всем требованиям VK Cloud к SDN:
- Архитектура трудно масштабируемая
- Ограничения по добавлении новой функциональности
- Сложно справляется с большим перестроением сети
...
> Подробнее о предпосылка создания собственной SDN в VK Cloud, также об отличительных особеностях работы читайте в [статье на Хабр](https://habr.com/ru/companies/vk/articles/763760/).
