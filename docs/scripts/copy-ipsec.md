...
Перед переносом ipsec необходимо создать аналогичную сетевую инфраструктуру на sprut. Здесь есть два варианта: 1) без транзитной сети 2) через транзитную сеть
